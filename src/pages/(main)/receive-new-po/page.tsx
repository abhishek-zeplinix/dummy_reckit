                            ...
                            <div className="px-2">
                                <div className="flex justify-content-between py-4">
                                    ...
                                    <span className="flex gap-5">
                                        <div className="" style={{ visibility: filterItems.length> 0 ? 'visible': 'hidden'}}>
                                            <Button
                                                icon="pi pi-refresh"
                                ...
                                <DataTable
                                    ...
                                    value={filterItems.length > 0 ? items.filter((ele) => filterItems.includes(ele.skuId)).reverse() : items.reverse()}
                                    className="erp-table"
                                    paginator
                                    rows={10}
                                    removableSort
