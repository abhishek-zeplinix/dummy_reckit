...
const RolePage = () => {
    ...
    const onNewAdd = async (companyForm: any) => {
        ...
        if (response.code == 'SUCCESS') {
            ...
            setAlert('success', 'Roles Added Successfully')
        }
        else {
    ...
    const onUpdate = async (companyForm: any) => {
        ...
        if (response.code == 'SUCCESS') {
            ...
            setAlert('success', 'Roles Updated Successfully')
        }
        else {
            setAlert('error', response.message)
        }
    ...
    const onDelete = async () => {
        ...
        if (response.code == 'SUCCESS') {
            ...
            setAlert('success', 'Roles Deleted Successfully')
        }
        else {
            setAlert('error', response.message)
        }
    ...
    const openDeleteDialog = (perm: CompanyRole) => {
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex flex-column w-full surface-border p-3">
                                                                    <div className="flex align-items-center">
                                                                        ...
                                                                        <span>
                                                                            This will permanently delete the selected Roles.
                                                                            <br />
