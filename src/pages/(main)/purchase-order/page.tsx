                    ...
                    <div className="col-5 col-offset-7">
                        <div className="flex justify-content-between align-items-baseline">
                            ...
                            <p className="font-bold">
                                {new Intl.NumberFormat('en-US', {
                                    ...
                                    currency: 'USD',
                                    minimumFractionDigits: 0, // Optional: set to 2 if you want cents (e.g., $2,000.00)
                                }).format(purchaseOrder.totalPrice)}
                            </p>
                        </div>
                        ...
                        <div className="flex justify-content-between align-items-baseline">
                            ...
                            <p className="font-bold">{new Intl.NumberFormat('en-US', {
                                        ...
                                        currency: 'USD',
                                        minimumFractionDigits: 0, // Optional: set to 2 if you want cents (e.g., $2,000.00)
                                    }).format(purchaseOrder.balancePrice)}</p>
                        </div>
                    </div>
                </div>
                <div className="mt-3">
                    ...
                    <div className="col-3">
                        <div className="flex justify-content-between">
                            ...
                            <p className="font-bold"> {new Intl.NumberFormat('en-US', {
                                    ...
                                    currency: 'USD',
                                    minimumFractionDigits: 0, // Optional: set to 2 if you want cents (e.g., $2,000.00)
                                }).format(sumBy(lineItems, (item) => item.quantity * item.price))}
                            </p>
                        </div>
                        <div className="flex justify-content-between">
                            <p className="font-bold">Paid</p>
                        ...
                        <div className="flex justify-content-between">
                            ...
                            <p className="font-bold">
                                {new Intl.NumberFormat('en-US', {
                                        ...
                                        currency: 'USD',
                                        minimumFractionDigits: 0, // Optional: set to 2 if you want cents (e.g., $2,000.00)
                                    }).format(sumBy(lineItems, (item) => item.quantity * item.price) - paid)}
                                </p>
                        </div>
                    </div>
                </div>
